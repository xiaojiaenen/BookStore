...
<div class="address">
    <div class="wrapper clearfix"><a href="indexselect">首页</a><span>/</span><a
            href="flowerDer.html">${title }</a>
            <c:if test="${title2!=null }">
            	<span>/</span><a href="proList.html" class="on">${title2 }</a></div>
            </c:if>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix">
    <c:if test="${title2!=null }">
    <h3 class="fl">${title2 }</h3>
    </c:if>
    <c:if test="${title2==null }">
...
<c:forEach items="${list }" var="l">
	<li><a href="selectproductview?id=${l.PRODUCT_ID }">
        <dl>
            <dt><img src="manage/images/product/${l.PRODUCT_FILENAME }" width="268px" height="268px"></dt>
            <dd>${l.PRODUCT_NAME }</dd>
            <dd>￥ ${l.PRODUCT_PRICE }</dd>
        </dl>
    </a></li>
</c:forEach>
