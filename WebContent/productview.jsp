...
<body>
	...
	<div class="address">
		<div class="wrapper clearfix">
			...
			<a href="flowerDer.html">${fname }</a><span>/</span>
			<a href="proList.html">${cname }</a><span>/</span>
			<a href="#" class="on">${pro.PRODUCT_NAME }</a>
		</div>
	</div>
	<!-----------------------Detail------------------------------>
	<div class="detCon">
		<div class="proDet wrapper">
			<div class="proCon clearfix">
				<div class="proImg fl">
					<img class="det" src="manage/images/product/${pro.PRODUCT_FILENAME }" />
					<div class="smallImg clearfix">
						<img src="manage/images/product/${pro.PRODUCT_FILENAME }"
							data-src="manage/images/product/${pro.PRODUCT_FILENAME }"><img
							src="manage/images/product/${pro.PRODUCT_FILENAME }" data-src="manage/images/product/${pro.PRODUCT_FILENAME }"><img
							src="manage/images/product/${pro.PRODUCT_FILENAME }" data-src="manage/images/product/${pro.PRODUCT_FILENAME }"><img
							src="manage/images/product/${pro.PRODUCT_FILENAME }" data-src="manage/images/product/${pro.PRODUCT_FILENAME }">
					</div>
				</div>
				<div class="fr intro">
					<div class="title">
					...
					<div class="proIntro">
						...
						<p>
							数量&nbsp;&nbsp;库存<span>${pro.PRODUCT_STOCK }</span>件
						</p>
					...
					<div class="btns clearfix">
						<a href="#2"><p class="buy fl">立即购买</p></a><a href="#2"><p
	...
	<div class="introMsg wrapper clearfix">
        ...
        <a href="selectproductview?id=${c.PRODUCT_ID }">
            <dl>
                <dt><img src="manage/images/product/${c.PRODUCT_FILENAME }" width="161px" height="200px"></dt>
                <dd>${c.PRODUCT_NAME }</dd>
                <dd>￥${c.PRODUCT_PRICE }</dd>
            </dl>
        </a>
        </c:forEach>
        </div>
